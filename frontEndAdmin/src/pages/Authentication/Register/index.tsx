...
import { userRegister } from "../AuthenSlice";
...
const Register = () => {
    ...
    // Function
    const handleSignUp = async (values: IFormSignUp) => {
            ...
            {formik => (
                <form onSubmit={formik.handleSubmit} className='signup-form'>
                    <div >
                        ...
                        <div className="inputBox">
                            <input type="submit" value='Đăng kí' id='btn' name='btnRegister' />
                        </div>
                        <div className="group">
                            <button name='btnCancleRegister' onClick={redictToLogin}>Hủy</button>
                            <button name='btnRedictLogin' onClick={redictToLogin}>Đăng nhập</button>
                        </div>
                    </div>
