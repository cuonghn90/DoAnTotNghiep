import { ChromeOutlined, UserOutlined, UnlockOutlined, GifOutlined } from '@ant-design/icons';
import './style.css';
...
const listItemNavbar = [
    ...
    {
        icon: <GifOutlined className='icon-navbar-setting' />,
        title: 'Mã giảm giá',
        describe: 'Mã giảm giá của tôi',
        value: 'my-coupon'
    },
    {
